...
// Complete list of countries supported by date.nager.at API
export const availableCountries: CountryInfo[] = [
...
// Sorted by name for a better user experience
export const sortedCountries = [...availableCountries].sort((a, b) => a.name.localeCompare(b.name));
